...
def t_to_sigma(
    t_tr: Tensor, t_rot: Tensor, t_tor: Tensor, t_sphere: Tensor, t_bl: Tensor,
    tr_sigma_min: float, tr_sigma_max: float, 
    rot_sigma_min: float, rot_sigma_max: float,
    tor_sigma_min: float, tor_sigma_max: float,
    sphere_sigma_min: float, sphere_sigma_max: float,
    bl_sigma_min: float, bl_sigma_max: float
    ...
    sphere_sigma = (sphere_sigma_min ** (1-t_sphere)) * (sphere_sigma_max ** t_sphere)
    bl_sigma = (bl_sigma_min ** (1-t_bl)) * (bl_sigma_max ** t_bl)
    return tr_sigma, rot_sigma, tor_sigma, sphere_sigma, bl_sigma
