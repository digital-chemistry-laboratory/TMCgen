...
from tmcgen.utils.schedulers import CosineAnnealingWarmupRestarts
...
def get_scheduler(
    ...
    if scheduler_name == 'plateau':
        ...
        print("Use the CosineAnnealingWarmupRestarts scheduler")
        # Use the CosineAnnealingWarmupRestarts class
